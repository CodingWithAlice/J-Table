...
export default function AnswerModal({ title, type, topicId, lastStatus, fresh }: { title: string, type: Type, topicId: number, lastStatus?: boolean, fresh?: () => void }) {
    ...
    return <>
        ...
        <Modal
            ...
            maskClosable={false}
        >
            {type === 'answer' && <Answer topicId={topicId} title={title} lastStatus={lastStatus} placeholder="请输入正确答案" closeModal={handleCancel} fresh={fresh} />}
